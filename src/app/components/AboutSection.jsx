...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Bacholer of science in computer sciences</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Dart And Flutter The Complete development Course</li>
        <Link
              href="/cert1.pdf"
              className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3"
            >
              <span className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2">
              Dart And Flutter The Complete development Course
              </span>
            </Link>
            <li>Dart & Flutter complete Bootcamp, Python for everyone, and Introduction to Data
            Science and Machine Learning.</li>
      </ul>
    ),
  },
];
